...
void timer_init(void) {
	...
	//TIM2 is 32-bits
	TimerStructPiezo.Init.Prescaler = 6000; /*!< prescaler value used to divide the TIM clock. Can be between Min_Data = 0x0000U and Max_Data = 0xFFFFU */
	...
	TimerStructPiezo.Init.Period = 7000;  //sysclk config /*!< Specifies the period value. Can be a number between Min_Data = 0x0000U and Max_Data = 0xFFFF.  */
