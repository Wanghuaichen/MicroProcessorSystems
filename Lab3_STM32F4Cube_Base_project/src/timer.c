...
void timer_init(void) {
	...
	__TIM2_CLK_ENABLE();
	TimerStructPiezo.Init.Prescaler = 40000; /*!< prescaler value used to divide the TIM clock. Can be between Min_Data = 0x0000U and Max_Data = 0xFFFFU */
	...
	TimerStructPiezo.Init.Period = 1;  /*!< Specifies the period value. Can be a number between Min_Data = 0x0000U and Max_Data = 0xFFFF.  */
	TimerStructPiezo.Init.ClockDivision = TIM_CLOCKDIVISION_DIV1;  /*!< Specifies the clock division. This parameter can be a value of @ref TIM_ClockDivision */
	...
	HAL_TIM_Base_Start(&TimerStructPiezo);
	//7 segment 2ms period for 5 digits is 10ms timer init (100Hz)
	__TIM3_CLK_ENABLE();
	TimerStruct7seg.Init.Prescaler = 40000; /*!< prescaler value used to divide the TIM clock. Can be between Min_Data = 0x0000U and Max_Data = 0xFFFFU */
	...
	HAL_TIM_Base_Start(&TimerStruct7seg);
