...
void timer_init(void) {
	...
	TimerStruct7seg.Init.Prescaler = 6000; /*!< prescaler value used to divide the TIM clock. Can be between Min_Data = 0x0000U and Max_Data = 0xFFFFU */
	...
	TimerStruct7seg.Init.Period = 7000;  /*!< Specifies the period value. Can be a number between Min_Data = 0x0000U and Max_Data = 0xFFFF.  */
