...
float getDeltaPitch(void);
uint8_t getHorizontalMovementDirection(void);
uint8_t getVerticalMovementDirection(void);

void setLeftButtonPress(void);
void setRightButtonPress(void);
void setScrollButtonPress(void);
